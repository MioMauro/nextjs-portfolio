...
return (
    <div className='fixed w-full h-20 shadow-xl z-[100]'>
        <div className='bg-white flex justify-between items-center w-full px-2 2xl:px-16'>
...
<div>
    ...
    <div className='border-b border-gray-300 my-4'>
        <p className='w-[85%] md:w-[90%] py-4'>Start build something legendary together</p>
    </div>
</div>
<div className='py-4 flex flex-col'>
    ...
    <div className='pt-40 '>
        <p className='uppercase -tracking-widest text-[#5651e5]'>Get connect</p>
